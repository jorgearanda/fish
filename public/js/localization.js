...
en['status_subWait'] = 'while other fishers are joining';           // RMK - to add for all languages
...
en['status_getReady'] = 'Get ready! The game is about to start.';           // RMK - to add for all languages
...
en['status_paused'] = 'Game paused.';           // RMK - to add for all languages
...
en['end_over'] = 'This game is over.';          // RMK - to add for all languages
cn['end_over'] = '模拟活动结束';
ct['end_over'] = '模擬活動結束';
